  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-6 text-primary font-lexend">Our Mission</h2>
            ...
            <h2 className="text-4xl font-bold text-primary border-t border-border pt-12 mt-8 font-lexend">The BEATS2BRIDGES Process</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <Card className="shadow-card">
              <CardContent className="p-6 text-center">
                <h3 className="text-xl font-semibold mb-3 text-primary font-lexend">STEP 1: MUSIC LESSONS</h3>
            ...
            <Card className="shadow-card">
              <CardContent className="p-6 text-center">
                <h3 className="text-xl font-semibold mb-3 text-primary font-lexend">STEP 2: HUNGRY FOR MUSIC</h3>
                <p className="text-muted-foreground font-lexend">
            ...
            <Card className="shadow-card">
              <CardContent className="p-6 text-center">
                <h3 className="text-xl font-semibold mb-3 text-primary font-lexend">STEP 3: MAKING CHANGE</h3>
                <p className="text-muted-foreground font-lexend">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-6 text-primary font-lexend">Gallery</h2>
          </div>
