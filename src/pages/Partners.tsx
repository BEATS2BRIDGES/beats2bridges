    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/50 py-12">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4 text-primary font-lexend">Our Partners</h1>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <Card className="shadow-accent">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-2xl text-primary">Hungry For Music</CardTitle>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-lg mb-3 text-primary">About Our Partnership</h4>
                ...
                <div className="space-y-4">
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <h5 className="font-semibold mb-2 text-primary">Partnership Highlights</h5>
